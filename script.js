...
const portfolioData = {
    ...
    'village-web': {
        ...
        paragraph2: 'Beyond basic information publishing, the websites integrate practical e-government services including online document requests, official announcement systems, and community feedback channels. The implementation actively serves 336 villages, with digital letter services reaching an average of 10 requests per day. While administrative volume per village is generally moderate, adoption remains strong because the workflow is simple and easy for village operators and residents to use. Recognition from provincial and national government digitization initiatives has established this project as a model for rural e-governance, with delegations from other provinces visiting to study the implementation methodology and training approach.'
    },
    'moramo-waterfall': {
    ...
    'smart-city': {
        ...
        layout: 6,
        images: [
            'images/additionals/smart city/IMG-20231006-WA0075.jpg.jpeg',
            'images/additionals/smart city/IMG-20240624-WA0061.jpg.jpeg',
            'images/additionals/smart city/IMG-20240825-WA0063.jpg.jpeg'
        ],
        paragraph1: 'The Smart City SPBE (Sistem Pemerintahan Berbasis Elektronik) Master Plan provides a comprehensive five-year roadmap for digital government transformation in Southeast Sulawesi province. In 2024, the Smart City assessment reached a score of 2.79 out of 4.00, with six core dimensions recorded as follows: Dimensi 1 Smart Governance (3,64), Dimensi 2 Smart Branding (2,69), Dimensi 3 Smart Economy (2,96), Dimensi 4 Smart Living (2,33), Dimensi 5 Smart Society (2,55), and Dimensi 6 Smart Environment (3,20). This strategic document defines the target architecture for integrated e-government services, data sharing protocols, and citizen-centric digital platforms aligned with Indonesia\'s national SPBE framework. The plan establishes governance structures including cross-agency coordination committees, data stewardship roles, and security management organizations essential for successful digital transformation. Detailed gap analysis identifies current system deficiencies and prioritizes investments in infrastructure, applications, and human capacity development.',
        paragraph2: 'The SPBE implementation showed measurable progress, with the regional SPBE index improving from 3.68 in 2024 to 3.87 in 2025, maintaining a Sangat Baik classification (3.5 to below 4.2). Evaluation follows 47 indicators across four core domains: Kebijakan SPBE, Tata Kelola SPBE, Manajemen SPBE, and Layanan SPBE. The assessment framework also uses five index levels: Kurang (<1.8), Cukup (1.8 to <2.6), Baik (2.6 to <3.5), Sangat Baik (3.5 to <4.2), and Memuaskan (4.2 to 5.0). Adopted as the official provincial digital government strategy, this master plan guides annual budgeting decisions and has attracted national recognition as a model for regional SPBE planning, with elements incorporated into guidance documents for other provinces.'
    },
    'text-analysis': {
    ...
    'llm-gateway-platform': {
        ...
        paragraph2: 'The gateway handles thousands of concurrent requests with low routing overhead, while Redis provides high-speed caching for frequently used prompts and responses. Deployed on Kubernetes for horizontal scalability, the platform automatically adjusts capacity based on demand patterns. It improved automation rate from around 50% to 80-90%, while keeping end-to-end latency below 70 seconds from user request submission until response delivery. Advanced features include prompt templating, response validation, token usage optimization, and automated A/B testing of different model configurations, enabling rapid experimentation while maintaining production stability and cost control across the organization\'s growing AI application portfolio.'
    }
};
